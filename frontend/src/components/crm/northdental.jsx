...
import teeth from "../../assets/images/hahead1.jpg";
...
const handleSubmit = async (e) => {
  ...
  const payload = {
    ...form,
    ...utmData,
    from_source: "New Patient Exam", // ✅ fixed value
  };
                    ...
                    <div className="col-md-6 text-center mb-md-0">
                      <div className="offer-image-container position-relative d-inline-block">
                        ...
                        <div className="flashing-cloud-text">
                          Free Electric Toothbrush included <br></br>with your New Patient Exam & Cleaning!
                        </div>
                      </div>
